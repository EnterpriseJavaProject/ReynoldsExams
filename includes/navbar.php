...
<li class="nav-item">
        ...
        <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <form action="pdfAllMaleStudentsPDF.php" method="POST">
               <button type="submit" name="btn_pdf" class="btn btn-light">All Male Students
               <?php
                      $connection = mysqli_connect("localhost","root","","registration");
                      $query = "SELECT id FROM students where gender = 'Male' ORDER BY id";
            ...
            <form action="pdfAllFemaleStudentsPDF.php" method="POST">
               <button type="submit" name="btn_pdf" class="btn btn-light">All Male Students
               <?php
                      $connection = mysqli_connect("localhost","root","","registration");
                      $query = "SELECT id FROM students where gender = 'Female' ORDER BY id";
                      $query_run = mysqli_query($connection, $query);
                      $row = mysqli_num_rows($query_run);
                      echo ': '.$row.' </a>';
                ?>
...
$connection = mysqli_connect("localhost","root","","registration");
$query = "SELECT username, lastactivity FROM `students` ORDER BY `lastactivity` DESC LIMIT 1";
$query_run = mysqli_query($connection, $query);
